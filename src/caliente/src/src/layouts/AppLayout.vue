...
const allNavigation = [
  ...
  { name: 'Calendario', path: '/sport-calendar', icon: 'calendar-days', roles: null },
    ...
    >
      ...
      <nav class="flex-1 py-3 px-2 space-y-0.5 overflow-y-auto">
        ...
        >
          ...
          <svg v-else-if="item.icon === 'calendar-days'" class="w-5 h-5 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
